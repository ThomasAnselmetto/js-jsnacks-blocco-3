...
// creare un array con un push dato dal Math.random che si trova nel range dell'utente
...
let numeroRandomico = Math.floor(Math.random() * (valoreMassimo - valoreMinimo)) + valoreMinimo;
